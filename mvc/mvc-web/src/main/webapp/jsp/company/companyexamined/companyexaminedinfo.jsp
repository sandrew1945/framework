		...
		<div class="col-md-12">
			...
			<form action="#" id="fm" class="form-horizontal form-horizontal"
				...
				<input type="hidden" id="companyId" name="companyId"
					value="${company.companyInfo.companyId} ">
			</form>
			<!-- BEGIN PAGE CONTENT-->
			<div class="row">
				<div class="col-md-12">
...
<script type="text/javascript">
	...
	function approvalPass() {
		bootbox.confirm("确认科技企业年审通过?", function(result) {
			if (result) {
				AjaxAnyWhere.sendRequestByForms("companyexamined/approvalPass",
						"fm", passCallback);
			}
		});
	}
	...
	function showReject() {
		bootbox.confirm("确认驳回申请?", function(result) {
			if (result) {
				$rejectModal.load(
						'jsp/company/companyexamined/modals/rejectmodal.jsp',
						'', function() {
							$rejectModal.modal();
							$("#modalcompanyId").val(
