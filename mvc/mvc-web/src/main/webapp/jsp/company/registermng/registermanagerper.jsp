...
<div class="row">
	<div class="col-md-12">
		...
		<h3 class="page-title">
			<span class="icon-svg2 icon-pad"></span> 注册企业管理
		</h3>
...
<!-- BEGIN PAGE CONTENT-->    
		...
		<div class="portlet-body">
			<div class="form-body">
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-4">
						<div class="form-group">
							...
							<div class="input-group col-md-9 col-sm-12 col-xs-12">
								<div class="" id="companyStatusDiv">
									<script type="text/javascript">getSelect('companyStatus','companyStatus','2007','',true,'form-control','','companyStatusDiv');
									</script>
								</div>
							</div>
						</div>
					...
					<div class="col-md-6 col-lg-4">
						<div class="form-group">
							<label class="control-label col-md-3">年审状态</label>
							<div class="input-group col-md-9 col-sm-12 col-xs-12">
								<div class="" id="examinedDiv">
									<script type="text/javascript">getSelect('examined','examined','2013','',true,'form-control','','examinedDiv');
									</script>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-md-6 col-lg-4">
						<div class="form-group">
							<label class="control-label col-md-3">科技企业</label>
							<div class="input-group col-md-9 col-sm-12 col-xs-12">
								<div class="" id="isTechCompanyDiv">
									<script type="text/javascript">getSelect('isTechCompany','isTechCompany','1003','',true,'form-control','','isTechCompanyDiv');
									</script>
								</div>
							</div>
						</div>
	...
	<div class="portlet light">
		<div class="portlet-title">
			...
			<div class="actions">
				<!-- <a href="javascript:void(0)" class="btn btn-circle green btn-sm" onclick="quickApproval()"><i class="icon-badge"></i> 认证 </a> -->
				<div class="btn-group">
...
<script type="text/javascript">
 	...
 	var option = 
 	{
 		 url:"registercompany/registerCompanyPageQuery",
 		 formId:"fm",
 		 choiceType:'radio',
 		 gridId:"myGrid",
 		 blankId:"_page",
 		 ...
 		 columns : [
			...
			{header: "用户名", width: "10%", dataIndex: "userCode"},
			{header: "密码", width: "10%", dataIndex: "password"},
			...
			{header: "审批状态", width: "10%", dataIndex: "companyStatus", renderer: getfixCodeDesc},
			{header: "年审状态", width: "10%", dataIndex: "examined", renderer: getfixCodeDesc},
			{header: "科技企业", width: "10%", dataIndex: "isTechCompany", renderer: getfixCodeDesc},
			{header: "联系人", width: "5%", dataIndex: "linkman"},
			{header: "联系人电话", width: "5%", dataIndex: "linkmanTel"},
			{header: "注册日期", width: "10%", dataIndex: "createDate", renderer: CommonUtil.getDateStr}
 		]
 	};
	...
	function deleteCompany()
	{
		...
		bootbox.confirm("是否删除该企业?", function(result){
			if(result)
			{
				AjaxAnyWhere.sendRequestByData("companyapproval/deleteCompany","companyId="+intHot, delCompanyCallback);
			}
		});
	}
	function delCompanyCallback(ajaxResult)
	{
	...
	function companyDetail(){
		...
		Metronic.loadContentData("registercompany/viewRegisterCompanyInfo?companyId="+intHot);
	}
	...
	function quickApproval()
	{
		var intHot = CommonUtil.getRadioVal();
		if(intHot==null){
			bootbox.alert("请选择要认证的企业?");
			return false;
		}
		bootbox.confirm("是否确认认证该企业?", function(result){
			if(result)
			{
				AjaxAnyWhere.sendRequestByData("companyapproval/approvalPass","companyId="+intHot, quickApprovalCallback);
			}
		});
	}
