			...
			<div class="form-body">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-md-3">企业审批情况：</label>
							<div id="isTechCompanyDiv" class="input-group col-md-9 col-sm-12 col-xs-12">
								<script type="text/javascript">getSelect('isTechCompany','isTechCompany','1003','${company.companyInfo.isTechCompany}',true,'form-control','','isTechCompanyDiv');</script>
							</div>
						</div>
					</div>
					<div class="col-md-6">
										...
										<optgroup label="本地企业">
											<c:forEach items="${companySources}" var="source">
												<c:if test="${source.sourceType == 20011001}">
										    		<option value="${source.sourceId}" <c:if test="${source.sourceId == company.companyInfo.sourceId}"> selected</c:if>>${source.sourceName}(本地企业)</option>
			 							    	</c:if>
										    </c:forEach>
									  	</optgroup>
										<optgroup label="引进企业">
											<c:forEach items="${companySources}" var="source">
												<c:if test="${source.sourceType == 20011002}">
										    		<option value="${source.sourceId}">${source.sourceName}(引进企业)</option>
										    	</c:if>
									    	</c:forEach>
									  	</optgroup>
										</select>
				...
				<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="input-group col-md-9 col-sm-12 col-xs-12">
									<input type="text" class="form-control" placeholder="高新技术企业认定编号" id="certCode" name="certCode" value="${company.companyInfo.certCode}" />
								</div>
							</div>
						</div>
				</div>
				...
				<div class="portlet light bordered">
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-12">
								<textarea rows="7" cols="100" class="form-control" id="introduction" name="introduction" placeholder="企业简介(限500字）" >${company.companyInfo.introduction}</textarea>
							</div>
						</div>
					</div>
				</div>
