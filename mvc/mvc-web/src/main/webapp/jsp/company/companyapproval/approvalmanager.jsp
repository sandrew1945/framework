...
<div class="row">
	<div class="col-md-12">
		...
		<h3 class="page-title">
			<span class="icon-svg2 icon-pad"></span> 科技企业审批管理
		</h3>
...
<script type="text/javascript">
 	...
 	var option = 
 	{
 		 url:"companyapproval/companyApprovalPageQuery",
 		 choiceType:'radio',
 		 formId:"fm",
 		 gridId:"myGrid",
 		 blankId:"_page",
	...
	function companyDetail(){
		...
		Metronic.loadContentData("companyapproval/viewCompanyApplyInfo?companyId="+intHot);
	}
