...
public class RoleManagerController extends BaseController
{
	...
	public @ResponseBody
	PageResult<TmRolePO> userManagerPageQuery(TmRolePO condition, int curPage) throws JsonException
	{
		try
		{
	...
	public @ResponseBody List<TmFunctionPO> queryRelationFunc(Integer roleId) throws JsonException
	{
		try
		{
	...
	public @ResponseBody List<TmFunctionPO> queryUnRelationFunc(Integer roleId, String functionName) throws JsonException
	{
		try
		{
