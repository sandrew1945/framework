...
public class TmUserPO extends PO
{
    ...
    @ColumnName(value = "is_login", isPK = false, autoIncrement = false)
    private Pack<Integer> isLogin;

    @ColumnName(value = "app_id", isPK = false, autoIncrement = false)
    private Pack<String> appId;
    ...
    public void setIsLogin(Integer isLogin)
    {
        ...
        {
            this.isLogin = new EqualPack<Integer>();
        }
        this.isLogin.setValue(isLogin);
    }

    public void setIsLogin(Pack<Integer> isLogin)
    {
    ...
    {
        return this.isLogin == null ? null : this.isLogin.getValue();
    }
    ...
    public void setAppId(String appId)
    {
        if (null == this.appId)
        {
            this.appId = new EqualPack<String>();
        }
        this.appId.setValue(appId);
    }

    public void setAppId(Pack<String> appId)
    {
        this.appId = appId;
    }
    ...
    {
        return this.appId == null ? null : this.appId.getValue();
    }
