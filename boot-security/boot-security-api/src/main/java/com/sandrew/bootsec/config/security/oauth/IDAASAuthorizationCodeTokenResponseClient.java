 ...
 * FileName: IDAASAuthorizationCodeTokenResponseClient
 * Author:   summer
...
/**
 * @ClassName IDAASAuthorizationCodeTokenResponseClient
 * @Description
 * @Author summer
 * @Date 2022/9/15 10:04
 **/
public class IDAASAuthorizationCodeTokenResponseClient implements OAuth2AccessTokenResponseClient<OAuth2AuthorizationCodeGrantRequest>
{

    private static final String INVALID_TOKEN_RESPONSE_ERROR_CODE = "invalid_token_response";

    private Converter<OAuth2AuthorizationCodeGrantRequest, RequestEntity<?>> requestEntityConverter = new IDaasOAuth2AuthorizationCodeGrantRequestEntityConverter();

    private RestOperations restOperations;

    public IDAASAuthorizationCodeTokenResponseClient()
    {
