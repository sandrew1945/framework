 ...
 * FileName: IDAASOAuth2UserService
 * Author:   summer
...
/**
 * @ClassName IDAASOAuth2UserService
 * @Description
 * @Author summer
 * @Date 2022/9/15 13:13
 **/
public class IDAASOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User>
{
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        return new DefaultOAuth2User(authorities, (Map<String, Object>) userAttributes.get("data"), userNameAttributeName);
    }
