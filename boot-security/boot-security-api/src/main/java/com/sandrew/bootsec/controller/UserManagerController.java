...
public class UserManagerController extends BaseController
{
    ...
    public @ResponseBody
    JsonResult getUserInfoById(Integer userId) throws JsonException
    {
        try
        {
     ...
     */
    @PostMapping(value = "/pushAppId")
    public @ResponseBody JsonResult pushAppId(String userCode, String appId) throws JsonException
    {
        try
        {
            return userManagerService.updateAppIdByCode(userCode, appId, getLoginUser());
        }
        catch (ServiceException e)
        {
            log.error(e.getMessage(), e);
