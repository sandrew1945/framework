...
import com.sandrew.bootsec.bean.FunctionsParam;
import com.sandrew.bootsec.bean.PermissionParam;
...
public class RoleManagerController extends BaseController
{
	...
	public @ResponseBody JsonResult roleValidate(String roleCode) throws JsonException
	{
		JsonResult result = new JsonResult();
		try
		{
