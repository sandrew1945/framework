package com.sandrew.bootsec.core.exception.handler;


import com.sandrew.bootsec.core.common.JsonResult;
import com.sandrew.bootsec.core.exception.ActionException;
	...
	public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, Object handler, Exception exception)
	{
		...
		try
		{
			if(handler instanceof HandlerMethod)
			{
				...
				if (responseBodyAnn != null || exception instanceof JsonException)
				{
					// 处理ajax请求异常
					...
					response.getWriter().write(JsonUtil.javaObject2String(result));
				}
