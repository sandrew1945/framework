package com.sandrew.bootcas.controller.login;
...
public class LoginController extends BaseController
{
    ...
    public String loginPre(Model model) throws ActionException
    {
        try
        {
            ...
            String userCode = (String) subject.getPrincipals().getPrimaryPrincipal();
    ...
    public String sso(HttpServletResponse response)
    {
        ...
        log.debug("in sso ===================" + subject.getSession().getId().toString());
